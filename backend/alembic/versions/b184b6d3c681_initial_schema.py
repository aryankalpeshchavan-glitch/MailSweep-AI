...
def upgrade() -> None:
    ...
    with op.batch_alter_table('audit_logs', schema=None) as batch_op:
        batch_op.create_index('ix_audit_logs_event_created', ['event_type', 'created_at'], unique=False)
    ...
    with op.batch_alter_table('analysis_jobs', schema=None) as batch_op:
        batch_op.create_index('ix_analysis_jobs_mailbox_status', ['mailbox_id', 'status'], unique=False)
    ...
    with op.batch_alter_table('email_groups', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_email_groups_mailbox_id'), ['mailbox_id'], unique=False)
    ...
    with op.batch_alter_table('email_messages', schema=None) as batch_op:
        batch_op.create_index('ix_email_messages_mailbox_domain', ['mailbox_id', 'sender_domain'], unique=False)
        batch_op.create_index(batch_op.f('ix_email_messages_mailbox_id'), ['mailbox_id'], unique=False)
        batch_op.create_index('ix_email_messages_mailbox_received', ['mailbox_id', 'received_at'], unique=False)
    ...
    with op.batch_alter_table('classifications', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_classifications_message_id'), ['message_id'], unique=True)

    op.create_table('cleanup_plan_items',
    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    with op.batch_alter_table('cleanup_plan_items', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_cleanup_plan_items_message_id'), ['message_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_cleanup_plan_items_plan_id'), ['plan_id'], unique=False)
    ...
    with op.batch_alter_table('recommendations', schema=None) as batch_op:
        batch_op.create_index('ix_recommendations_mailbox_action', ['mailbox_id', 'action'], unique=False)
        batch_op.create_index('ix_recommendations_mailbox_status_risk', ['mailbox_id', 'status', 'risk'], unique=False)
        batch_op.create_index(batch_op.f('ix_recommendations_message_id'), ['message_id'], unique=True)
    ...
    with op.batch_alter_table('user_decisions', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_user_decisions_message_id'), ['message_id'], unique=False)
